...
public class ElevatorPriorityTest {
    ...
    public void isMovingTowardsLevel_moving_towards_the_request_UP_returns_true() {
        ElevatorController controller = new ElevatorController(new Elevator("A", 0, 5, new ElevatorState(MovementState.MOVING, UP)), 1, 10, 20);
    ...
    public void isMovingTowardsLevel_moving_towards_the_request_DOWN_returns_true() {
        ElevatorController controller = new ElevatorController(new Elevator("A", 0, 5, new ElevatorState(MovementState.MOVING, DOWN)), 1, 10, 20);
    ...
    public void isMovingTowardsLevel_elevator_stopped_returns_false() {
        ElevatorController controller = new ElevatorController(new Elevator("A", 0, 5, new ElevatorState(MovementState.IDLE, UP)), 1, 10, 20);
    ...
    public void getSuitabilityScore() {
        ...
        int score_a = new ElevatorController(new Elevator("A", 0, 5, new ElevatorState(MovementState.MOVING, UP)), 1, 10, 20).getSuitabilityScore(request);
        int score_b = new ElevatorController(new Elevator("A", 0, 6, new ElevatorState(MovementState.MOVING, UP)), 1, 10, 20).getSuitabilityScore(request);
    ...
    public void getSuitabilityScore2() {
        ...
        int score_a = new ElevatorController(new Elevator("A", 0, 5, new ElevatorState(MovementState.MOVING, UP)), 1, 10, 20).getSuitabilityScore(request);
        int score_b = new ElevatorController(new Elevator("A", 0, 6, new ElevatorState(MovementState.MOVING, DOWN)), 1, 10, 20).getSuitabilityScore(request);
        System.out.println("a => " + score_a);
        System.out.println("b => " + score_b);
    ...
    public void getSuitabilityScore4() {
        ...
        int score_a = new ElevatorController(new Elevator("A", 0, 1, new ElevatorState(MovementState.IDLE, UP)), 1, 10, 20).getSuitabilityScore(request);
        int score_b = new ElevatorController(new Elevator("A", 0, 4, new ElevatorState(MovementState.MOVING, UP)), 1, 10, 20).getSuitabilityScore(request);
        System.out.println("a => " + score_a);
        System.out.println("b => " + score_b);
    ...
    public void getSuitabilityScore5() {
        ...
        int score_a = new ElevatorController(new Elevator("A", 0, 9, new ElevatorState(MovementState.IDLE, UP)), 1, 10, 20).getSuitabilityScore(request);
        int score_b = new ElevatorController(new Elevator("A", 0, 9, new ElevatorState(MovementState.MOVING, UP)), 1, 10, 20).getSuitabilityScore(request);
        System.out.println("a => " + score_a);
        System.out.println("b => " + score_b);
